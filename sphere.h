...
public:
    ...
    float shininess;
    // ctor/dtor
    BulbSphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 diff = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(24)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, shiny);
        buildCoordinatesAndIndices();
        buildVertices();
    ...
    // draw in VertexArray mode
    void drawBulbSphere(Shader& lightingShader, glm::mat4 model) const      // draw surface
    {
        lightingShader.use();
...
public:
    ...
    float shininess;
    // ctor/dtor
    Cylinder(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.0, 0.0, 0.0), glm::vec3 diff = glm::vec3(0.0, 0.0, 0.0), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(24)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, shiny);
        buildCoordinatesAndIndices();
        buildVertices();
...
public:
    ...
    float shininess;
    // ctor/dtor
    DiscTex(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.922, 0.91, 0.902), glm::vec3 diff = glm::vec3(0.922, 0.91, 0.902), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(32)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, shiny);
        buildCoordinatesAndIndices();
        buildVertices();
...
public:
    ...
    float shininess;
    // ctor/dtor
    HemiSphereTex(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.102, 0.098, 0.098), glm::vec3 diff = glm::vec3(0.102, 0.098, 0.098), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(32)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, shiny);
        buildCoordinatesAndIndices();
        buildVertices();
    ...
    // draw in VertexArray mode
    void drawHemiSphere(Shader& lightingShader, unsigned int texture, glm::mat4 model) const      // draw surface
    {
        lightingShader.use();
...
private:
    ...
    void buildCoordinatesAndIndices()
    {
        ...
        for (int i = 0; i <= stackCount; ++i)
        {
            stackAngle = (i * (-PI / (2 * stackCount))); // from 0 to pi/2
            xz = radius * cosf(stackAngle);
            y = radius * sinf(stackAngle);
            ...
            for (int j = 0; j <= sectorCount; ++j)
            {
                sectorAngle = j * (-2 * PI / sectorCount); // from 0 to 2pi
                ...
                // Texture coordinates (s, t)
                if (j == sectorCount) {
                    // Ensure the texture seam is smooth by repeating s=0 at the last vertex
                    s = 1.0f;
                }
                else {
                    s = (float)j / sectorCount; // U-coordinate
                }
                t = 1.0f - (float)i / stackCount; // V-coordinate starts at 1.0 at the base and decreases
                texCoords.push_back(s);
                texCoords.push_back(t);
            }
        }
...
public:
    ...
    float shininess;
    // ctor/dtor
    HalfDiscTex(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(0.922, 0.91, 0.902), glm::vec3 diff = glm::vec3(0.922, 0.91, 0.902), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), float shiny = 32.0f) : verticesStride(32)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec, shiny);
        buildCoordinatesAndIndices();
        buildVertices();
